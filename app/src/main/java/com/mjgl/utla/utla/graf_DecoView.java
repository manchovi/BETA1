...
public class graf_DecoView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //String str = "inicio:"+String.valueOf(temperature)+","+String.valueOf(humedity)+"fin";
        String str = message;
        ...
        temperatura(Float.parseFloat(temperatura));
        humedadRH(Float.parseFloat(humedad));

        dialog_SMSINTO(addres,temperatura,humedad);
    ...
    public void dialog_SMSINTO(String telefono,String temperatura,String humedad){
        ...
        tv_title.setText("MONITOREO GSM [INPUT SMS]");
        address.setText("Message From :"+telefono);
    ...
    private void goMenu(){
        ...
        dialogo = new AlertDialog.Builder(graf_DecoView.this);
